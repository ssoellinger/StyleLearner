        ...
        )
        {
               ...
               )
            {
                using (MemoryStream fileIpRange = new MemoryStream())
                {
                    ...
                    ipRanges = CsvImporter
                                  .FromStream<DlsIpRange>(
                                       fileIpRange,
                                       "|"
                                  );
                }
               ...
               )
            {
                using (MemoryStream fileIpClient = new MemoryStream())
                {
                    ...
                    ipClients = CsvImporter
                                    .FromStream<DlsIpClient>(
                                            fileIpClient,
                                            "|"
                                     );
                }
               ...
               )
            {
                using (MemoryStream fileMobility = new MemoryStream())
                {
                    ...
                    mobilities = CsvImporter
                                    .FromStream<DlsMobility>(
                                        fileMobility,
                                        "|"
                                     );
                }
